    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 mb-20">
      <div className="bg-white rounded-2xl p-8 md:p-12 lg:p-16">
        ...
        <button
          ...
          className="mt-8 flex items-center gap-2 text-emerald-600 hover:text-emerald-700 font-semibold text-lg transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 rounded-lg px-4 py-2"
