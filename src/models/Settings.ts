...
const SettingsSchema = new Schema<ISettings>(
  {
    ...
    seo: {
      ...
      metaDescription: { type: String, default: 'Shop premium abayas, hijabs, modest dresses and Islamic fashion at Diaraya Outlet. Elegant styles, quality fabrics and fast delivery across Pakistan.' },
      ...
      ogDescription: { type: String, default: 'Shop premium abayas, hijabs, modest dresses and Islamic fashion at Diaraya Outlet. Elegant styles, quality fabrics and fast delivery across Pakistan.' },
      ogImage: { type: String, default: '/images/og-image.jpg' },
      twitterCard: { type: String, default: 'summary_large_image' },
      twitterTitle: { type: String, default: 'Diarayao Outlet' },
      twitterDescription: { type: String, default: 'Shop premium abayas, hijabs, modest dresses and Islamic fashion at Diaraya Outlet. Elegant styles, quality fabrics and fast delivery across Pakistan.' },
