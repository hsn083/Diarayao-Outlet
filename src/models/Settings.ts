...
const SettingsSchema = new Schema<ISettings>(
  {
    general: {
      ...
      siteLogo: { type: String, default: '/favicon.png' },
      ...
      companyAddress: { type: String, default: 'Faisalabad, Pakistan' },
      footerInfo: { type: String, default: '© 2026 Diarayao Outlet. All rights reserved.' },
    ...
    seo: {
      metaTitle: { type: String, default: 'Diarayao Outlet | Premium Abayas & Modest Fashion' },
      metaDescription: { type: String, default: 'Premium Abayas, Hijabs & Modest Fashion in Pakistan. Quality fabrics, fast delivery.' },
      metaKeywords: { type: String, default: 'abayas, hijabs, modest fashion, Islamic clothing, modest dresses, Pakistan' },
      ogTitle: { type: String, default: 'Diarayao Outlet | Premium Abayas & Modest Fashion' },
      ogDescription: { type: String, default: 'Premium Abayas, Hijabs & Modest Fashion in Pakistan. Quality fabrics, fast delivery.' },
      ogImage: { type: String, default: '/images/og-image.jpg' },
      twitterCard: { type: String, default: 'summary_large_image' },
      twitterTitle: { type: String, default: 'Diarayao Outlet | Premium Abayas & Modest Fashion' },
      twitterDescription: { type: String, default: 'Premium Abayas, Hijabs & Modest Fashion in Pakistan. Quality fabrics, fast delivery.' },
      twitterImage: { type: String, default: '/images/twitter-image.jpg' },
      robots: { type: String, default: 'index, follow' },
      canonicalUrl: { type: String, default: 'https://www.diarayao.com' },
      structuredData: {
        organization: {
          name: { type: String, default: 'Diarayao Outlet' },
          url: { type: String, default: 'https://www.diarayao.com' },
