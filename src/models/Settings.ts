...
const SettingsSchema = new Schema<ISettings>(
  {
    ...
    seo: {
      ...
      metaDescription: { type: String, default: 'Shop premium Abayas, Hijabs & Modest Dresses in Pakistan. Quality fabrics, fast delivery.' },
      ...
      ogDescription: { type: String, default: 'Shop premium Abayas, Hijabs & Modest Dresses in Pakistan. Quality fabrics, fast delivery. Order online at Diaraya Outlet!' },
      ogImage: { type: String, default: '/images/og-image.jpg' },
      twitterCard: { type: String, default: 'summary_large_image' },
      twitterTitle: { type: String, default: 'Diarayao Outlet' },
      twitterDescription: { type: String, default: 'Shop premium Abayas, Hijabs & Modest Dresses in Pakistan. Quality fabrics, fast delivery. Order online at Diaraya Outlet!' },
